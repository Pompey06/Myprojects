         ...
         <div class="content">
            <section class="info bg__wrap">
               ...
               <div class="info__content higher">
                  ...
                  <h1 class="info__title">
                     Prêt à être repéré ?<br />
                     <span class="lower">Rejoins-nous avec 87 % de réduction !</span>
                  </h1>
                  <p class="info__text">
                     Des joueurs âgés de 6 à 21 ans sont découverts par de vrais recruteurs et entraîneurs dans le monde
                     entier !
                  </p>
                  <a data-redirect="1" href="#" class="join__button">Rejoins-nous maintenant !</a>
                  <div class="subscription__text hide-850">
                     Crée ton profil joueur avant le 1er septembre 2025 et <br />
                     débloque 2 ANS d'accès complet pour seulement
                     <br />
                     12,99 $ (Prix habituel : 99,98 $)
                  </div>
                  <div class="subscription__text show-850">
                     Build your player profile until September 1, 2025, and unlock 2 YEARS of full access for just
                     $12.99 <br />
                     (Normally $99.98)
                  </div>
               </div>
                  ...
                  <div class="invisible__content">
                     <div class="invisible__content_top">
                        <h2 class="invisible__title">
                           Les joueurs les plus talentueux restent
                           <span class="red">invisibles...</span>
                        </h2>
                        <img src="../image/content__image.png" alt="" class="invisible__image show-850" />

                        <p class="invisible__text">
                           Des milliers de jeunes joueurs n’obtiennent jamais la chance qu’ils méritent - non pas à
                           cause de leur niveau, mais par manque de visibilité.
                        </p>
                     </div>
                     <div class="invisible__lines hide-420">
                        <div class="invisible__line">
                           ...
                           <div class="invisible__line_text">
                              <span class="red">Pas de vidéo</span> = pas de visibilité
                           </div>
                        </div>
                        <div class="invisible__line">
                           <img src="../image/access.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text">
                              <span class="red">Pas d’accès aux recruteurs</span> = pas de progression
                           </div>
                        </div>
                        <div class="invisible__line">
                           <img src="../image/profile.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text">
                              <span class="red">Pas de profil en ligne</span> = opportunités manquées
                           </div>
                        </div>
                     </div>
                     <div class="invisible__lines show-420">
                        <div class="invisible__line">
                           <img src="../image/video.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text">
                              <span class="red">Pas de vidéo</span> <br />
                              = pas de visibilité
                           </div>
                        </div>
                        <div class="invisible__line">
                           <img src="../image/access.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text">
                              <span class="red">Pas d’accès aux recruteurs</span> <br />
                              = pas de progression
                           </div>
                        </div>
                        <div class="invisible__line">
                           <img src="../image/profile.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text">
                              <span class="red">Pas de profil en ligne</span> <br />
               ...
               <div class="opportunities__wrapper">
                  <div class="opportunities__content">
                     <h2 class="opportunities__title">
                        Transforme ton talent en <span class="green">vraies opportunités !</span>
                     </h2>
                     <p class="opportunities__text">
                        WorldTalentRadar te donne tout ce qu’il faut pour faire avancer ta carrière footballistique !
                     </p>
                     ...
                     <ul class="opportunities__list">
                        ...
                        <li>
                           ...
                           indique ton poste, tes gestes techniques, tes buts...
                        </li>
                        <li>
                           <img src="../image/03.svg" alt="" class="opportunities__list_number" />
                           Montre tes meilleures actions en vidéos et photos, ajoute tes réseaux sociaux
                        </li>
                        <li>
                           <img src="../image/04.svg" alt="" class="opportunities__list_number" />
                           Sois repéré partout dans le monde!
                        </li>
                     </ul>
                     <a data-redirect="2" href="#" class="join__button">Rejoins-nous maintenant</a>
                  </div>
            ...
            <footer class="footer">
               ...
               <div class="footer__links">
                  <a href="#" class="footer__link ">Politique de cookies</a>
