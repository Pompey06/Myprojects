            ...
            <section class="info bg__wrap">
               ...
               <div class="info__content higher">
                  ...
                  <h1 class="info__title">
                     Ready to Be Seen?<br />
                     <span class="lower">Join with 87% discount!</span>
                  </h1>
                  <p class="info__text">
                     Players aged 6–21 are getting discovered <br />
                     by real scouts and coaches - worldwide!
                  </p>
                  <a data-redirect="1" href="#" class="join__button">Join Now!</a>
                  <div class="subscription__text hide-850">
                     Build your player profile until September 1, 2025, <br />
                     and unlock 2 YEARS of full access for just $12.99 <br />
                     (Normally $99.98)
                  </div>
