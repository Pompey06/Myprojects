            ...
            <section class="info bg__wrap">
               ...
               <div class="info__content higher">
                  ...
                  <h1 class="info__title">
                     Готов заявить о себе?<br />
                     <span class="lower">Присоединяйся со скидкой 87 %!</span>
                  </h1>
                  <p class="info__text">Cкауты и тренера находят талантливых игроков от 6 до 21 по всему миру!</p>
                  <a data-redirect="1" href="#" class="join__button">Присоединиться сейчас</a>
                  <div class="subscription__text hide-850">
                     Создай профиль до 1 сентября 2025 года <br />
                     и получи 2 ГОДА полного доступа всего за $12.99 <br />
                     (Обычно $99.98)
                  </div>
                  <div class="subscription__text show-850">
                     Создай профиль до 1 сентября 2025 года и получи 2 ГОДА полного доступа всего за $12.99 <br />
                     (Обычно $99.98)
                  </div>
               </div>
            </section>
                  ...
                  <div class="invisible__content">
                     <div class="invisible__content_top">
                        <h2 class="invisible__title">
                           Самые талантливые игроки остаются <span class="red">незамеченными...</span>
                        </h2>
                        <img src="../image/content__image.png" alt="" class="invisible__image show-850" />

                        <p class="invisible__text">
                           Тысячи молодых футболистов так и не получают свой шанс - не из-за недостатка мастерства, а
                           из-за отсутствия видимости.
                        </p>
                     </div>
                     <div class="invisible__lines hide-420">
                        <div class="invisible__line">
                           <img src="../image/video.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text"><span class="red">Нет видео</span> = нет видимости</div>
                        </div>
                        <div class="invisible__line">
                           <img src="../image/access.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text">
                              <span class="red">Нет доступа к скаутам</span> = нет прогресса в карьере
                           </div>
                        </div>
                        <div class="invisible__line">
                           <img src="../image/profile.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text">
                              <span class="red">Нет онлайн-профиля</span> = упущенные возможности
                           </div>
                        </div>
                     </div>
                     <div class="invisible__lines show-420">
                        <div class="invisible__line">
                           <img src="../image/video.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text">
                              <span class="red">Нет видео</span> <br />
                              = нет видимости
                           </div>
                        </div>
                        <div class="invisible__line">
                           <img src="../image/access.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text">
                              <span class="red">Нет доступа к скаутам</span> <br />
                              = нет прогресса в карьере
                           </div>
                        </div>
                        <div class="invisible__line">
                           <img src="../image/profile.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text">
                              <span class="red">Нет онлайн-профиля</span> <br />
               ...
               <div class="opportunities__wrapper">
                  <div class="opportunities__content">
                     <h2 class="opportunities__title">
                        Преврати свой талант в <span class="green">реальные возможности!</span>
                     </h2>
                     <p class="opportunities__text">
                        WorldTalentRadar даёт всё необходимое, чтобы продвигать свою футбольную карьеру!
                     </p>
                     ...
                     <ul class="opportunities__list">
                        ...
                        <li>
                           ...
                           Укажи позицию на поле, финты, цели
                        </li>
                        <li>
                           <img src="../image/03.svg" alt="" class="opportunities__list_number" />
                           Покажи себя при помощи видео, фото и добавь соцсети
                        </li>
                        <li>
                           <img src="../image/04.svg" alt="" class="opportunities__list_number" />
                           Тебя увидят по всему миру!
                        </li>
                     </ul>
                     <a data-redirect="2" href="#" class="join__button">Присоединяйся сейчас</a>
                  </div>
