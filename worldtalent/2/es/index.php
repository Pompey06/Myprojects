            ...
            <section class="info bg__wrap">
               ...
               <div class="info__content higher">
                  ...
                  <h1 class="info__title">
                     ¿Listo para ser descubierto?<br />
                     <span class="lower"> ¡Únete con un 87 % de descuento!</span>
                  </h1>
                  <p class="info__text">
                     Jugadores de entre 6 y 21 años están siendo descubiertos por ojeadores y entrenadores reales en
                     todo el mundo.
                  </p>
                  <a data-redirect="1" href="#" class="join__button">¡Únete ahora!</a>
                  <div class="subscription__text hide-850">
                     Crea tu perfil de jugador antes del 1 de septiembre <br />
                     de 2025 y consigue 2 AÑOS de acceso total por solo <br />
                     $12,99 (Normalmente $99,98)
                  </div>
