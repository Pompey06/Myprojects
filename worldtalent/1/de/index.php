         ...
         <div class="content">
            <section class="info bg__wrap">
               ...
               <div class="info__content higher">
                  ...
                  <h1 class="info__title">
                     Träumst du von einer <br />
                     <span class="lower">Fußballkarriere?</span>
                  </h1>
                  <p class="info__text">
                     Die Plattform, auf der Fußballspieler <br />
                     (im Alter von 6 bis 21 Jahren) echte Scouts und Trainer aus der ganzen Welt treffen!
                  </p>
                  <a data-redirect="1" href="#" class="join__button">Jetzt beitreten</a>
               </div>
            </section>
                  ...
                  <div class="invisible__content">
                     <div class="invisible__content_top">
                        <h2 class="invisible__title">
                           Die talentiertesten Spieler bleiben oft <span class="red">unsichtbar...</span>
                        </h2>
                        <img src="../image/content__image.png" alt="" class="invisible__image show-850" />

                        <p class="invisible__text">
                           Tausende junge Spieler bekommen nie die Chance, die sie verdienen - nicht wegen fehlender
                           Fähigkeiten, sondern wegen fehlender Sichtbarkeit.
                        </p>
                     </div>
                     <div class="invisible__lines hide-420">
                        <div class="invisible__line">
                           ...
                           <div class="invisible__line_text">
                              <span class="red">Kein Video</span> = keine Sichtbarkeit
                           </div>
                        </div>
                        <div class="invisible__line">
                           <img src="../image/access.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text">
                              <span class="red">Kein Zugang zu Scouts</span> = kein Karriereschritt
                           </div>
                        </div>
                        <div class="invisible__line">
                           <img src="../image/profile.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text">
                              <span class="red">Kein Online-Profil</span> = verpasste Chancen
                           </div>
                        </div>
                     </div>
                     <div class="invisible__lines show-420">
                        <div class="invisible__line">
                           <img src="../image/video.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text">
                              <span class="red">Kein Video</span> <br />
                              = keine Sichtbarkeit
                           </div>
                        </div>
                        <div class="invisible__line">
                           <img src="../image/access.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text">
                              <span class="red">Kein Zugang zu Scouts</span> <br />
                              = kein Karriereschritt
                           </div>
                        </div>
                        <div class="invisible__line">
                           <img src="../image/profile.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text">
                              <span class="red">Kein Online-Profil</span> <br />
                              = verpasste Chancen
                           </div>
                        </div>
                     </div>
               ...
               <div class="opportunities__wrapper">
                  <div class="opportunities__content">
                     <h2 class="opportunities__title">
                        Mach aus deinem Talent <span class="green">echte Chancen!</span>
                     </h2>
                     <p class="opportunities__text">
                        WorldTalentRadar bietet dir alles, was du brauchst, um deine Fußballkarriere zu fördern!
                     </p>
                     ...
                     <ul class="opportunities__list">
                        ...
                        <li>
                           ...
                           Teile deine Position, Technik, Tore...
                        </li>
                        <li>
                           <img src="../image/03.svg" alt="" class="opportunities__list_number" />
                           Zeige deine besten Aktionen mit Videos und Fotos, verlinke deine Social Media
                        </li>
                        <li>
                           <img src="../image/04.svg" alt="" class="opportunities__list_number" />
                           Werde weltweit entdeckt!
                        </li>
                     </ul>
                     <a data-redirect="2" href="#" class="join__button">Jetzt beitreten</a>
                  </div>
            ...
            <footer class="footer">
               ...
               <div class="footer__links">
                  <a href="#" class="footer__link">Cookie-Richtlinie</a>
                  <a href="#" class="footer__link">Allgemeine Geschäftsbedingungen</a>
                  <a href="#" class="footer__link">Datenschutzrichtlinie</a>
