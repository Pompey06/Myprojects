         ...
         <div class="content">
            <section class="info bg__wrap">
               ...
               <div class="info__content higher">
                  ...
                  <h1 class="info__title">
                     Sonha com uma carreira <br />
                     <span class="lower">no futebol?</span>
                  </h1>
                  <p class="info__text">
                     A plataforma onde jogadores de futebol <br />(dos 6 aos 21 anos) se conectam com verdadeiros
                     olheiros e treinadores do mundo inteiro!
                  </p>
                  <a data-redirect="1" href="#" class="join__button">Junte-se agora</a>
               </div>
            </section>
                  ...
                  <div class="invisible__content">
                     <div class="invisible__content_top">
                        <h2 class="invisible__title">
                           LOs jogadores mais talentosos permanecem <span class="red">invisíveis...</span>
                        </h2>
                        <img src="../image/content__image.png" alt="" class="invisible__image show-850" />

                        <p class="invisible__text">
                           Milhares de jovens nunca recebem a chance que merecem - não por falta de talento, mas por
                     ...
                     <div class="invisible__lines hide-420">
                        <div class="invisible__line">
                           ...
                           <div class="invisible__line_text"><span class="red">Sem vídeo</span> = sem visibilidade</div>
                        </div>
                        <div class="invisible__line">
                           <img src="../image/access.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text">
                              <span class="red">Sem acesso a olheiros</span> = sem progresso na carreira
                           </div>
                        </div>
                        <div class="invisible__line">
                           <img src="../image/profile.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text">
                              <span class="red">Sem perfil online</span> = oportunidades perdidas
                           </div>
                        </div>
                     </div>
                     <div class="invisible__lines show-420">
                        <div class="invisible__line">
                           <img src="../image/video.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text">
                              <span class="red">Sem vídeo</span> <br />
                              = sem visibilidade
                           </div>
                        </div>
                        <div class="invisible__line">
                           <img src="../image/access.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text">
                              <span class="red">Sem acesso a olheiros</span> <br />
                              = sem progresso na carreira
                           </div>
                        </div>
                        <div class="invisible__line">
                           <img src="../image/profile.svg" alt="" class="invisible__line_icon" />
                           <div class="invisible__line_text">
                              <span class="red">Sem perfil online</span> <br />
               ...
               <div class="opportunities__wrapper">
                  <div class="opportunities__content">
                     <h2 class="opportunities__title">
                        Transforme o seu talento em <span class="green">oportunidades reais!</span>
                     </h2>
                     <p class="opportunities__text">
                        O WorldTalentRadar oferece tudo o que você precisa para promover a sua jornada no futebol!
                     </p>
                     ...
                     <ul class="opportunities__list">
                        ...
                        <li>
                           ...
                           Compartilhe sua posição, habilidades, gols...
                        </li>
                        <li>
                           <img src="../image/03.svg" alt="" class="opportunities__list_number" />
                           Mostre suas melhores jogadas com vídeos e fotos, adicione suas redes sociais
                        </li>
                        <li>
                           <img src="../image/04.svg" alt="" class="opportunities__list_number" />
                           Seja encontrado no mundo todo!
                        </li>
                     </ul>
                     <a data-redirect="2" href="#" class="join__button">Junte-se agora</a>
                  </div>
            ...
            <footer class="footer">
               ...
               <div class="footer__links">
                  ...
                  <a href="#" class="footer__link">Termos e Condições</a>
                  <a href="#" class="footer__link">Política de Privacidade</a>
                  <a href="#" class="footer__link">Impressão</a>
               </div>
            </footer>
         </div>
      </div>
