            ...
            <section class="info bg__wrap">
               ...
               <div class="info__content higher">
                  ...
                  <h1 class="info__title">
                     Мечтaешь о карьере <br />
                     <span class="lower">футболиста?</span>
                  </h1>
                  <p class="info__text">
                     Платформа, где футболисты <br />(от 6 до 21 года) находят настоящих скаутов и тренеров по всему
                     миру!
                  </p>
                  <a data-redirect="1" href="#" class="join__button">Присоединяйся сейчас</a>
               </div>
            </section>
