   ...
   <body class="ru">
      ...
      <picture>
         ...
         <div class="content">
            ...
            <h1 class="title">Твое футбольное будущее начинается здесь!</h1>
            <p class="text">
               Присоединяйся к платформе, где футболисты (от 6 до 21 года) связываются со скаутами и тренерами по всему
               миру!
            </p>
            <div class="discount show-1024">
               <h3 class="discount__title">СКИДКА 87 %!</h3>
               <p class="discount__text">До 1 сентября 2025</p>
            </div>
            <a data-redirect="1" href="#" class="join__button hide-550">Присоединиться сейчас!</a>
            <div class="footer">
               <img src="../image/ball.svg" alt="" class="ball hide-550" />

               <div class="footer__text">
                  Создай свой профиль сегодня и получи <br />
                  <span class="green">2 ГОДА полного доступа всего за $12.99</span> <br />
                  (Обычная цена: $99.98)
               </div>
               <div class="offer hide-1600">Предложение действительно до 1 сентября 2025 года</div>
               <div class="offer show-1600">
                  Предложение действительно <br />
                  до 1 сентября 2025 года
               </div>
               <a data-redirect="1" href="#" class="join__button show-550">Присоединиться сейчас!</a>
            </div>
